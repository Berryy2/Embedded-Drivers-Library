...
#include "spi.h"
/* To Setup the SPI pins direction */
#include "gpio.h"
/* To use the macros like SET_BIT */
#include "common_macros.h"
/* To use the SPI Registers */
#include "avr/io.h"
...
void SPI_initMaster(void) 
{
	 ...
	 * MISO(PB6) --> Input
	 * SCK(PB7) --> Output
	 * When we intiate as slave we will just flip them.
	 ********************************************/
...
void SPI_receiveString(uint8 *str)
{
	...
	// SPI must recieve while sending so while it recieves a string it will just send like
	// dummy message to complete the communication and usually this dummy message = 0xFF
	// which is declared in spi header file.
